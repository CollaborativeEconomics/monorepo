...
import { ConfigContext } from '@/src/components/config';
import ButtonWallet from '@/src/components/ButtonWallet';
import { fetchApi, postApi } from '@/src/utils/api';
        ...
        <div className="text-center flex flex-col justify-center items-center">
          ...
          <li className="list-none my-4">
            <p className="text-xl mt-4">
              We use Freighter wallet for Soroban Network
            </p>
            <p>
              Download{' '}
          ...
          <p className="text-sm text-slate-400 mt-8">
            You will need to have XLM in a wallet that supports Soroban Network,
            such as Freighter. Freighter is a secure, non-custodial, end-to-end
            encrypted, blockchain wallet. You can learn more in their website.
          </p>
        </div>
      </div>
    </div>
