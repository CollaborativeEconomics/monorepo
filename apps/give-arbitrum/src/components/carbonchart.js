...
function CarbonChart({ title, goal = 100, value = 0, max100 = true }) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement("div", { style: style.chart },
            offs.map(() => { return (React.createElement("div", { style: style.off, key: Math.random() })); }),
            dec > 0 ? (React.createElement("div", { style: prt })) : React.createElement(React.Fragment, null),
            tons.map(() => { return (React.createElement("div", { style: style.ton, key: Math.random() })); }))));
}
