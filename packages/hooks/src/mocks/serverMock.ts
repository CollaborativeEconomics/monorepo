...
const handlers = [
  ...
  http.get("https://registry.cfce.io/api/hooks", ({ request }) => {
  ...
  http.get(
    ...
    ({ request }) => {
      ...
      const wrongAddress =
        address !== "GC53JCXZHW3SVNRE4CT6XFP46WX4ACFQU32P4PR3CU43OB7AKKMFXZ6Y"
    ...
    },
    {
      actionDefinition: {
        ...
        parameters: {
          ...
          headers: null,
          endpoint:
            "https://api-beta.stellarcarbon.io/registry/retirements?for_address={input.walletAddress}&date_gte={yesterday}",
        },
      },
    },
    {
  ...
  retirements: [
    {
      ...
      vcu_amount: 9,
      serial_numbers:
        "8040-449402283-449402291-VCU-042-MER-PE-14-1360-01072013-30062014-1",
      retirement_date: "2023-05-07",
      retirement_beneficiary:
        "GC53JCXZHW3SVNRE4CT6XFP46WX4ACFQU32P4PR3CU43OB7AKKMFXZ6Y via stellarcarbon.io",
      retirement_details:
